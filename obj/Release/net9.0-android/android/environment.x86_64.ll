...
@aot_dso_cache = dso_local local_unnamed_addr global [819 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 u0x0e44ee5ce78ae98d, ; from name: aot-sampledb
		i64 u0x128173298916a276, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-sampledb.dll.so
		ptr null; void* handle
	}, ; 58
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x128173298916a276, ; from name: libaot-sampledb.dll.so
		i64 u0x128173298916a276, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-sampledb.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x7fe356396a6ee934, ; from name: sampledb
		i64 u0x128173298916a276, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-sampledb.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x94ddd90a29c48a1a, ; from name: aot-sampledb.dll.so
		i64 u0x128173298916a276, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-sampledb.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xb07e9b6d77eca187, ; from name: sampledb.dll.so
		i64 u0x128173298916a276, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-sampledb.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xb868f16c1aac0344, ; from name: libaot-sampledb
		i64 u0x128173298916a276, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-sampledb.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xbe152c975ddcbc9c, ; from name: libaot-sampledb.so
		i64 u0x128173298916a276, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-sampledb.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xddc22b8447b1719f, ; from name: aot-sampledb.so
		i64 u0x128173298916a276, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-sampledb.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xde15e4da48fd7a4d, ; from name: sampledb.so
		i64 u0x128173298916a276, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-sampledb.dll.so
		ptr null; void* handle
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [25 x i8] c"com.companyname.sampledb\00", align 16
...
@.DSOCacheEntry.9_name = private unnamed_addr constant [23 x i8] c"libaot-sampledb.dll.so\00", align 16
